...
EMSCRIPTEN_BINDINGS(mod)
{
  ...
  value_object<MoveInfo>("MoveInfo")
      .field("move", &MoveInfo::move)
  ...
  class_<Clock>("Clock")
      ...
      .function("getTimeSpentThisTurn", &Clock::getTimeSpentThisTurn)
  ...
  register_vector<PieceIdentifier>("vector<PieceIdentifier>");
  register_vector<std::vector<PieceIdentifier>>("vector<vector<PieceIdentifier>>");
}
