...
Version Server::version = Version("Revenge Chess Server, standard compliant", 'x', 1, 1, 0);
// change the version name here if the server should reject the vanilla client
Version Server::minimum_client_version = Version("standard compliant", 'x', 2, 8, 0);
